...
const EN: LocalePools = {
  positive: {
    ...
    reactSpec: [
      ...
      "Great to hear the {spec} stood out.",
      "Nothing makes us happier than hearing the {spec} hit the spot.",
      "We're proud of the {spec}, so thank you for calling it out.",
      "Lovely to hear the {spec} did the trick.",
      "We care a lot about the {spec}, so this means a lot.",
      "Chuffed the {spec} lived up to it.",
      "Happy the {spec} came out as good as we hoped.",
      ...
      "Hearing the {spec} landed makes the early mornings worth it.",
      "We take real pride in the {spec}, glad it showed.",
    ...
    reactPair: [
      ...
      "So pleased the {spec} landed, and the {spec2} too.",
    ...
    kwWoven: [
      ...
      "\"{kw}\" isn't just a line for us, it's what we work toward every day.",
      "Everything here starts with \"{kw}\", and we hold ourselves to that.",
      "We take \"{kw}\" seriously around here, so this was great to read.",
      "Your review is exactly why we keep pushing on \"{kw}\".",
      "That's what \"{kw}\" is all about, and we're glad you stopped in.",
  ...
  mixed: {
    ...
    reactSpec: [
      ...
      "That's fixable, and we fully intend to fix the {spec}.",
    ...
    reactPair: [
      ...
      "Happy the {spec} stood out, and we hear you on the {spec2}.",
  ...
  negative: {
    ...
    reactSpec: [
      ...
      "I've raised the {spec} with the team directly.",
