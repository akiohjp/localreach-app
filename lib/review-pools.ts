...
const EN_GENERIC: PoolSet = {
  ...
  coresLong: [
    "The {list} really stood out.",
    "Loved the {list}, that was the highlight for me.",
    "The {list} alone made the trip worth it.",
    "{store} absolutely nailed the {list}.",
    "Honestly the {list} was the best part of the visit.",
    "The {list} is the reason I'll be going back.",
    "Big fan of the {list} here.",
    "Can't say enough about the {list}.",
    "What got me was the {list}, genuinely good.",
    "The {list} was even better than I expected.",
  ],
  coresCompact: [
    "Loved the {list}.",
    "The {list} was spot on.",
    "The {list}, so good.",
    "Highlight was the {list}.",
    "Go for the {list}.",
    "The {list} won me over.",
    "{store} nailed the {list}.",
    "Big yes to the {list}.",
  ],
  dualBlocks: [
    "The {a} was great, and the {b} was just as good.",
    "Loved the {a}, and the {b} was a nice surprise too.",
    "The {a} stood out first, then the {b} sealed it.",
    "Between the {a} and the {b}, {store} won me over.",
  ],
  bridgesLong: [
  ...
  tails: [
    "Also have to mention the {kw}.",
    "The {kw} lived up to the hype.",
    "Really enjoyed the {kw}.",
    "No notes on the {kw}.",
    "Ask about the {kw} while you're there.",
    "The {kw} is worth it on its own.",
    "Definitely try the {kw}.",
    "The {kw} was a highlight.",
    "Also a big fan of the {kw}.",
  ],
  microOpeners: [
