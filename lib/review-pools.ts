...
const EN_GENERIC: PoolSet = {
  ...
  bridgesLong: [
    ...
    "Someone checked in on us at {just the right moment|the right times|exactly the right point}, not a minute too often.",
  ...
  closersLong: [
    ...
    "Do yourself a favour and {check out|visit|look up} {store}.",
  ...
  fillers: [
    ...
    "You {notice|can feel|can tell} the difference when people take {pride|real pride|genuine care} in their work.",
    "I'm {fussy|picky|particular} about this kind of thing, and I left with {nothing to pick at|no complaints|nothing to fault}.",
    "My expectations were {high|set high|not low} and they still {cleared|beat|passed} them.",
    "Not a {single|solitary} thing I'd change about the {visit|experience|whole thing}.",
    "Half the battle is {just doing what you promise|getting the basics right|being consistent}, and they do.",
    "Came out in a better mood than I went in, which {says a lot|is rarer than it sounds|counts for plenty}.",
...
const JA_GENERIC: PoolSet = {
  ...
  coresLong: [
    "特に{list}が良かったです。",
    "{list}が{一番の魅力|何よりの収穫|いちばんの決め手}でした。",
  ...
  closersLong: [
    ...
    "今度は別の楽しみ方で{store}を試してみるつもりです。",
    "人を連れて行くなら{store}と決めました。",
    "こういう{お店|場所}が近くにあるのは、素直に{うれしい|心強い|ありがたい}です。",
    "{行こうか迷っていた時間|様子見していた期間|先延ばしにしていた日々}がもったいなかったです。",
    "次は待たずに{store}へ行きます。",
...
const AR_GENERIC: PoolSet = {
  openersLong: [
    ...
    "زميلي في العمل ذكر {store} أكثر من مرة، فذهبت لأرى بنفسي.",
    "وصلت إلى {store} بالصدفة تقريباً، وكانت صدفة موفقة.",
    "هذه زيارتي الثانية إلى {store} هذا الشهر، وهذا يقول كل شيء.",
    "اخترنا {store} لمناسبة صغيرة وكان اختياراً موفقاً.",
    "كان عندي وقت فراغ في المنطقة فجرّبت {store}.",
    "بعد يوم طويل، كان {store} تماماً ما أحتاجه.",
    "أخذت صديقاً زائراً إلى {store} وخرجنا كلانا معجبين.",
    "قرأت التقييمات قبل زيارة {store}، وتبيّن أنها صادقة.",
  ],
  openersShort: [
    ...
    "كلمة سريعة عن {store}.",
    "{store} كما هو دائماً، ممتاز.",
    "أخيراً جرّبت {store}، وكان قراراً صائباً.",
    "{store} عند حسن الظن.",
    "تجربة مريحة مع {store}.",
  ],
  coresLong: [
  ...
  bridgesLong: [
    ...
    "رغم الازدحام، بقيت الخدمة منظمة وهادئة.",
    "أجابوا عن أسئلتي بوضوح ومن دون مبالغة في العرض.",
    "كانوا صريحين بشأن ما هو متاح وما ليس متاحاً، وهذا يُحترم.",
    "التعامل كان مهذباً وطبيعياً، من دون تكلّف.",
    "شعرت أن المستوى نفسه يتكرر في كل زيارة.",
    "اهتموا بنا من الدخول حتى الخروج من دون مبالغة.",
  ],
  bridgesShort: [
    "خدمة ودودة وسريعة.",
    "نظيف ومريح.",
  ...
  closersLong: [
    ...
    "حدّثت اثنين من أصدقائي عن {store} منذ زيارتي.",
    "في المرة القادمة لن أنتظر طويلاً قبل العودة إلى {store}.",
    "سأصطحب ضيوفي إلى {store} من الآن فصاعداً.",
    "{store} استحق هذا التقييم عن جدارة.",
    "خرجت من {store} سعيداً أنني جئت.",
    "صار {store} خياري الجاهز عندما يسألني أحد.",
  ],
  closersShort: [
    "أوصي بشدة بـ {store}.",
    "سأعود.",
...
const EN_VERTICAL: Partial<Record<Vertical, Partial<PoolSet>>> = {
  ...
  cafe: {
    openersLong: [
      ...
      "Meant to make it a quick stop at {store}, and that plan fell apart in the best way.",
    ],
