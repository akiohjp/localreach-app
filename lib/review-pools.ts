...
const AR_GENERIC: PoolSet = {
  openersLong: [
    "مررت مؤخراً على {store} وأحببت أن أدوّن ما لفت انتباهي، بلا مبالغة، فقط النقاط التي تهم لو سألني صديق.",
    "كنت أنوي تجربة {store} منذ فترة، وجاءت الزيارة أفضل مما توقعت، وما زالت بعض التفاصيل واضحة في ذهني في اليوم التالي.",
    "كانت أول زيارة لي إلى {store} أفضل مما ظننت، وسأعود إليها من دون تردد.",
    "لست هنا لأكتب مقالاً طويلاً، لكن {store} فاجأني في نقاط محددة، ولهذا أترك هذا التقييم.",
    "دخلت {store} بتوقعات عادية وخرجت بقائمة صغيرة من الأمور الجيدة التي ظللت أفكر فيها لاحقاً.",
    "لو سألني أحدهم عن {store} على فنجان قهوة، فهذه هي النسخة الصادقة: لحظات قليلة كانت مميزة، والانطباع العام إيجابي.",
    "أكتب هذا لأن {store} أتقن بعض التفاصيل التي لا أريد اختصارها في عدد نجوم فقط.",
    "بصراحة، {store} لم يحاول اختراع شيء جديد، وهذا ما أعجبني؛ الإتقان كان أهم من البهرجة.",
    "زرت {store} في يوم مزدحم وتوقعت بعض الفوضى، لكن الأداء كان أكثر ثباتاً مما اعتدت عليه.",
    "جمع {store} الكثير من النقاط الجيدة الهادئة خلال الزيارة، من النوع الذي نادراً ما يجتمع معاً.",
    "ظل صديق يوصيني بتجربة {store}، وبعد أن ذهبت أخيراً فهمت لماذا لم يتوقف عن ذكره.",
    "لا أكتب تقييماً لكل مكان أزوره، لكن {store} قدّم ما يكفي ليستحق دقيقتين من وقتي.",
    "وصلت إلى {store} بالصدفة تقريباً، وتحولت الزيارة إلى واحدة من تلك التي أكرر الحديث عنها.",
    "كتبت هذا في المساء نفسه لأن تفاصيل {store} كانت ما زالت واضحة ولم أرد أن أنساها.",
  ],
  openersShort: [
    "انطباع سريع عن {store}: زيارة جيدة بشكل عام، وبعض النقاط تستحق الذكر.",
    "مررت على {store} قبل فترة قصيرة، وكانت النقاط الجيدة واضحة كفاية لأتذكرها.",
    "{store} لم يكن مثالياً بالكامل، لكن ما كان جيداً حقيقي كفاية لأعود إليه.",
    "{store}؟ نعم، سأكرر التجربة.",
    "باختصار: {store} قدّم ما يهم فعلاً.",
    "أكتب والانطباع ما زال طازجاً. في {store} كانت هناك لحظات لافتة.",
    "{store} ليس ضجيجاً تسويقياً، بل تجربة متينة وبسيطة.",
    "بصراحة {store} صار على قائمة زياراتي القادمة، وهذا غير معتاد من أول زيارة.",
    "خرجت من {store} بمزاج جيد، وهذا يقول معظم ما تحتاج معرفته.",
    "أوصي بـ {store} من دون تحفظ يُذكر.",
  ],
  coresLong: [
    "أكثر ما لفت انتباهي كان {list}. في {store} لم يكن ذلك مجرد كلام، بل شعرت أن أحدهم يهتم فعلاً بإتقانه.",
    "لو وصفت الزيارة بعبارات قليلة لاخترت {list}. حافظ {store} على ذلك من البداية إلى النهاية.",
    "ما سأكرره لزميل أو جار هو {list}، وهي أمور محددة كفاية بحيث لا ألجأ إلى مديح عام.",
    "أساس ما أعجبني يعود إلى {list}. {store} لم يتعامل مع ذلك باستهتار.",
    "إن اختصرت الأمر، كانت الزيارة أساساً {list} بعناية، وهذه قصة {store}.",
    "أبرز ما رأيته كان {list}، و{store} لم يعامل ذلك كأمر ثانوي.",
    "ما أوجّه الناس إليه هو {list}، و{store} قدّمه فعلاً كما يجب.",
    "{list} هي الطريقة الصادقة لأشرح لماذا أوصي بـ {store} من دون تجميل.",
    "لو سألتني عما تتوقعه من {store} لأشرت مباشرة إلى {list} من دون مواربة.",
    "ما بقي في ذهني فعلاً هو {list}، وحافظ {store} على ثباته طوال الوقت.",
  ],
  coresCompact: [
    "ما نجح فعلاً: {list}.",
    "{store} تميّز في {list}.",
    "أبرز ما أذكره هو {list}.",
    "النقاط اللافتة: {list}.",
    "{store}: {list}. هذا يكفي.",
    "باختصار من {store}: {list}.",
    "إن ذهبت، انتبه إلى {list}.",
  ],
  dualBlocks: [
    "خيط واحد عبر الزيارة كان {a}؛ وبشكل منفصل، برز {b} أيضاً في {store} من دون أن يبدو مقحماً.",
    "ظهر {a} أولاً بالنسبة لي؛ ثم جاء {b} ليكمل الصورة، وكلاهما بدا مقصوداً في {store}.",
    "سأقسّمها: {a} صنع البداية، و{b} أنهى الانطباع، وبدا الأمر متماسكاً في {store}.",
    "بعيداً عن الأجواء العامة، الملموس هو {a} إلى جانب {b} في {store}.",
  ],
  bridgesLong: [
    "كان طاقم {store} منسجماً مع بقية التجربة: متعاون حين احتجت شيئاً، وغير متطفل بقية الوقت.",
    "المكان كان مريحاً، وإيقاع الخدمة مناسباً، لا متعجلاً ولا بطيئاً.",
    "ما دفعته بدا عادلاً مقابل ما حصلت عليه؛ لم تكن هناك لحظة شعرت فيها بالمبالغة في السعر.",
    "تعاملوا مع تغيير بسيط من دون أي عناء، وهذا النوع من الأمور يبقى في الذاكرة.",
    "قرأ {store} الموقف بشكل صحيح: مرحاً حين يناسب، وهادئاً حين لا يناسب.",
    "لم يجعلني أطارد أي شيء؛ كل ما احتجته في {store} أُنجز بسرعة.",
    "المكان نظيف ومعتنى به، وهذا النوع من العناية لا تلاحظه إلا حين يغيب في مكان آخر.",
    "كانوا صادقين بشأن التوقيت بدل المبالغة في الوعود، وجرى الأمر تماماً كما قالوا.",
  ],
  bridgesShort: [
    "خدمة الاستقبال في {store} كانت منسجمة مع كل شيء آخر.",
    "لا شيء بدا مرتجلاً. {store} كان متماسكاً.",
    "{store} أبقى الأمور تسير من دون أن يجعلني أراقب الساعة.",
    "كان من السهل الاستقرار في المكان، بلا ارتباك.",
    "التفاصيل الصغيرة عولجت في {store}، والتفاصيل الصغيرة تتراكم.",
    "من الواضح أن {store} يهتم بتفاصيل يتجاهلها كثيرون.",
  ],
  closersLong: [
    "سأعود إلى {store} من دون تفكير طويل، وما ذكرته أعلاه هو ما سأقوله لمن يختار هذا الأسبوع.",
    "أوصي بـ {store} بارتياح: عادل مقابل ما حصلت عليه، والزيارة كانت سهلة من البداية إلى النهاية.",
    "الخلاصة: {store} أتقن الأمور المهمة، وإن كانت تجربتي معتادة فهو خيار متين.",
    "سأضع {store} ضمن خياراتي؛ ليس كل مكان يستحق ذلك بعد زيارة واحدة.",
    "{store} من الأماكن التي أرشّحها لمن يقول إن كل التقييمات تبدو مزيفة، لأن زيارتي كانت واقعية.",
    "إن كان بقية الفريق مثل من تعاملت معه، فـ {store} خيار آمن.",
    "سأبقيها بسيطة: {store} أنصفني، وسأقول لصديق الشيء نفسه.",
    "هل سأعود إلى {store}؟ أخطط لذلك بالفعل.",
  ],
  closersShort: [
    "{store} يحصل على نعم مني؛ سأعود.",
    "سأرسل الناس إلى {store}؛ كان يستحق الوقت.",
    "بلا تعقيد: {store} كان جيداً ببساطة.",
    "دع التفكير الزائد وجرّب {store}.",
    "متين في كل شيء. {store} يستحق ذلك.",
    "سأعود إلى {store} غداً بلا تردد.",
    "{store}: أوصي به بلا تحفظ.",
  ],
  fillers: [
    "هذا الثبات في الجودة سبب كبير لأختار {store} مجدداً بدل المخاطرة بمكان جديد.",
    "حين خرجت من {store}، كنت أعرف أنني سأعود، وهذه عادةً علامة جيدة.",
    "نادراً ما أغادر {store} من دون أي ملاحظة، وهذه المرة كانت الملاحظات صغيرة.",
    "بدا {store} مكاناً يريد زبائن يعودون، لا زيارة واحدة تنتهي.",
    "هناك فرق بين مكان مقبول ومكان تقترحه بنفسك؛ {store} من الصنف الثاني بالنسبة لي.",
    "قيمة الثبات لا تُدرك إلا حين تفتقدها، و{store} حافظ عليها طوال الزيارة.",
  ],
  tails: [
    "{kw} كان من أبرز النقاط بالنسبة لي.",
    "قدّموا ما يجب في {kw}.",
    "لا ملاحظات على {kw}.",
    "{kw} بدا صادقاً، لا مقحماً.",
    "سأشير إلى {kw} لو سألني أحد عما يتوقعه.",
    "{kw} لم يضِع وسط الزحام.",
    "{kw} يستحق الزيارة وحده.",
    "{kw} كان عند مستوى ما سمعته عنه.",
  ],
  microOpeners: [
    "أدوّن هذا قبل أن أنسى.",
    "ليس تقييماً منمّقاً، مجرد ملاحظة صادقة.",
    "سأبقيه قصيراً عن قصد.",
  ],
  noKeywordMid: [
    "سارت الزيارة بسلاسة، وما زلت أذكر {store} كمكان أعود إليه من أجل الخدمة والأجواء العامة وحدها.",
    "لا شيء مثير للدراما، وهذا هو المقصد: {store} أتقن الأساسيات وجعل الأمر سهلاً.",
  ],
};
...
const AR_VERTICAL: Partial<Record<Vertical, Partial<PoolSet>>> = {
  restaurant: {
    ...
    coresLong: [
      "أكثر ما نجح كان {list}. في {store} ظهر ذلك من أول قضمة إلى آخرها.",
      "إن اختصرت الوجبة، كانت أساساً {list} بعناية، وهذا هو {store}.",
    ],
    bridgesLong: ["بدا الحساب عادلاً مقابل الكميات، وواكبت الخدمة إيقاع المطبخ في {store}."],
