...
const RETAIL: StoryFrame[] = [
  ...
  { size: "short", text: "{Nothing complicated|Not much to it}: {store} had {obj1}, {the price was|prices were} {clear|fair}, and {I was out in ten minutes|nobody wasted my time}.[ {svc1} was {handled|sorted} on the spot.][ {aside}]" },
  ...
  { size: "medium", text: "What I'd {mention|point to} first about {store} is {attr1}[, then {attr2}]. I {went in|dropped in} {expecting|braced for} the usual {pitch|hard sell} and got {none of it|the opposite}.[ {obj1} {came home with me|was what I left with}.][ {aside}][ {svc1} was {handled|sorted} {without me asking|on the spot}.] {Prices|The prices} {stayed where they said|were clear}, and I was {out|done} in {twenty minutes|no time}." },

  // ---- long ----
  { size: "long", text: "I'd walked past {store} {a few times|for weeks|more than once} before going in, and I'm {annoyed|a bit annoyed} I waited. {The first thing I bought was|I started with} {obj1}[, then went back for {obj2}][ and {obj3}].[ {What I didn't expect was|The surprise was} {attr1}, the kind of thing you only notice when it's done right.][ {svc1} was {sorted|handled} without me having to ask.][ {aside}] {Nobody hovered|No pressure at any point|Nobody followed me around}, {the prices were|pricing was} {clear|straightforward}, and {when I had questions|whenever I asked something} I got {a proper answer|an actual answer} rather than a {sales line|pitch}.[ If you're after {geo1}, {this is where I'd send you|start here}.] I'd {easily|happily} recommend it." },
  { size: "long", text: "{Long overdue|Overdue} review for {store}. I've been buying {obj1} {here|from them} for {months|a while|most of the year} now[, and {recently|lately} added {obj2}].[ {What keeps me coming back|The reason I keep coming back} is {partly|mostly} {attr1}, {but also|and} {the fact that|that} {nobody ever tries to upsell me|I've never once been oversold}.][ {svc1} has been {reliable|consistent} every time.][ {aside}][ {If you're after|For} {geo1}, {this is the place I'd send you|I'd start here}.][ They {know|really know} their {range1}.] {I've|We've} {sent|pointed} {a couple of friends|two friends} {their way|here} already." },
...
const RESTAURANT: StoryFrame[] = [
  ...
  { size: "medium", text: "{Takeaway|Delivery} from {store} {on Friday|last night|midweek} and it {travelled|held up} {fine|well}. {obj1} {was still hot|arrived hot}[, and {obj2} {survived the trip|came through intact}].[ {aside}][ {svc1} {worked|went} {as promised|without a hitch}.] {The portions|Portions} were {generous|proper}[, and {attr1} {came through|held up} even out of the box]. {We'll|I'll} order again." },
...
const CAFE: StoryFrame[] = [
  ...
  { size: "long", flavors: ["doughnut", "bakery", "coffee"], text: "{Needed|Was after} something {for the office|for a birthday|for a friend} and {a colleague|a friend} {suggested|recommended} {store}. {Went with|Ordered} {obj1}[ and {obj2}] and {they|the shop} {packed|boxed} it {properly|carefully} {without me asking|on the spot}. {It|Everything} {arrived|was} {fresh|exactly as described}, looked {the part|as good as it should}, and {was gone|disappeared} {within the hour|before I'd finished my coffee}.[ {svc1} was {smooth|painless} too.][ {aside}][ {attr1} didn't hurt either.] {Everyone|People} asked where it was from, {which is the point|which says it all}, and I've {since|already} been back {for myself|on my own account}." },
