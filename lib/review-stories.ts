...
const RESTAURANT: StoryFrame[] = [
  ...
  { size: "short", text: "{Keeping it short|Short version}, {store} {got|gets} {obj1} right[, and {attr1} {does the rest|seals it}].[ {aside}] {Nothing fancy|No fuss}, {just|and} {done properly|done well}." },
