...
export const STORY_ASIDES: Record<StoryFlavor, readonly string[]> = {
  ...
  doughnut: [
    "The doughnuts were still {soft|fresh} the next morning.",
    "The box {barely|didn't} survive the drive home.",
    "The box didn't last the {afternoon|day}.",
    "The doughnuts were {clearly|obviously} made that {day|morning}.",
    "Not {too sweet|overly sweet}, which I appreciate.",
  ],
  bakery: [
    "Everything was still {soft|fresh} the next morning.",
    "Nothing was left by {the evening|the next day}.",
    "Everything was {clearly|obviously} baked that {day|morning}.",
    "Not {too sweet|overly sweet}, which I appreciate.",
  ],
  tea: [
    "The tea itself is {properly|clearly} good, not just the packaging.",
    "The tea made a {better|nicer} gift than I expected.",
    "They explained how to prepare the tea {without being asked|properly}.",
...
const RETAIL: StoryFrame[] = [
  ...
  { size: "short", text: "{obj1} at {store} lived up to {what people say|the recommendation|the write-ups}[, and {attr1} did not go unnoticed either].[ {aside}]" },
  ...
  { size: "short", text: "{Stopped by|Dropped into|Called in at} {store} {on a whim|between errands|after work} and left with {obj1}. It's a {good|solid|proper} shop with {no pressure|no hard sell}, and {they knew their stuff|the advice was straight}.[ {attr1} {stood out too|didn't go unnoticed either}.]" },
  ...
  { size: "short", text: "The thing I'd {flag|mention|point to} about {store} is {attr1}. {That's|It's} {what I'd tell a friend first|why I'd go back|the part that stayed with me}.[ {obj1} {did not disappoint either|held up too}.][ {aside}]" },
  ...
  // ---- medium ----
  { size: "medium", text: "I'd been meaning to {try|check out|get to} {store} for a while and finally went in {last week|the other day|this month}. {Ended up with|Came away with|Left with} {obj1}[ and {obj2}], and it turned out to be {a good call|the right choice|money well spent}.[ {aside}][ {attr1} {stood out too|didn't go unnoticed either}.] {The staff|The person who helped me|Whoever was on} {took their time|actually listened|asked what I wanted} instead of pushing {the most expensive thing|whatever was new|the display stock}, which {is rarer than it should be|I appreciated|made the difference}.[ For {geo1}, {this is where I'd send people|I'd start here}.]" },
  ...
  { size: "medium", text: "If you're {hunting|searching|looking} for {geo1}, {store} {belongs on the list|is where I'd start|is the one I'd name}. I {went in for|asked about} {obj1}, got {a straight answer|honest advice} rather than a pitch, and {left|walked out} with {exactly what I wanted|something I actually use}.[ {aside}][ {attr1} {sealed it|made the difference}.][ They carry a {good|solid} range of {range1}.]" },
  { size: "medium", text: "{Two|A couple of} things stood out at {store}. The first was {obj1}, which {lived up to|matched} {the description|what I'd heard}.[ The second was {svc1}, {done|handled} properly and {without me having to chase|without any back and forth}.][ {attr1} {didn't go unnoticed either|stood out too}.][ {aside}] They're small things, but they're why I'd go back." },
  ...
  { size: "medium", text: "{Nice|Good|Reassuring} to have this kind of {cat} in {loc} that {actually|really} {knows its stuff|does this properly}. I picked up {obj1}[ and {obj2}] at {store} and {the whole thing|it} was {easy|painless}.[ {aside}][ {attr1} {stood out too|didn't go unnoticed either}.] There was {no hard sell|zero pressure}, just {honest|straight} answers." },
  ...
  { size: "medium", text: "{Ordered|Got} {obj1}[ and {obj2}] from {store} for {my mother|a friend's birthday|the house|a colleague}. Everything {arrived|came} {intact and|properly packed and} {looking the part|exactly as described}[, and {svc1} went {quickly|as promised}].[ {aside}] {The person|Whoever} I spoke to {before ordering|beforehand} {actually knew|knew} the products, which {made the choice easy|helped}.[ {attr1} {didn't hurt either|helped too}.]" },
  { size: "medium", text: "{Second|Third} time at {store} and {the standard|it} {hasn't slipped|held up}. {Had|Went for|Got} {obj1} again[, plus {obj2} this time]. {The staff|Whoever was on} {remembered|recognised} me, which {I didn't expect|was a nice touch}.[ {aside}][ {attr1} is {still|again} the part I'd {mention|point to} first.][ For {geo1}, {this is my answer|I'd start here}.]" },
  ...
  { size: "long", text: "This is an overdue review for {store}. I've been buying {obj1} {here|from them} for {months|a while|most of the year} now[, and {recently|lately} added {obj2}].[ {What keeps me coming back|The reason I keep coming back} is {partly|mostly} {attr1}, {but also|and} {the fact that|that} {nobody ever tries to upsell me|I've never once been oversold}.][ They've been {reliable|consistent} with {svc1} every time.][ {aside}][ {If you're after|For} {geo1}, {this is the place I'd send you|I'd start here}.][ They {know|really know} their {range1}.] {I've|We've} {sent|pointed} {a couple of friends|two friends} {their way|here} already." },
...
const RESTAURANT: StoryFrame[] = [
  ...
  { size: "short", text: "Had a {good|solid|proper} {meal|dinner} at {store}. What {stood out|I remember} most is {attr1}, which {you don't get everywhere|is rarer than it should be}.[ {obj1} {held up too|did not disappoint either}.] {Would|I'd} {happily|gladly} go back." },
  ...
  { size: "short", text: "{Weeknight|Midweek} dinner at {store} and it {delivered|did the job}. {obj1} {came out|arrived} {quickly|fast}[, {attr1} came {as promised|as advertised}], and we were {out|done} in {under an hour|forty minutes} {without feeling rushed|and didn't feel rushed}." },
  ...
  { size: "short", text: "{Keeping it short|Short version}, {store} {got|gets} {obj1} right[, and {attr1} {does the rest|seals it}].[ {aside}] It's {nothing fancy|no-fuss}, {just|and} {done properly|done well}." },
  ...
  { size: "medium", text: "Had {lunch|dinner} at {store} {with a colleague|with my partner|on my own} {yesterday|earlier this week|on Tuesday}. {Went with|Picked} {obj1}, which {arrived|came} {fast|quickly} and {hot|properly hot}[, and {obj2} {on the side|to share}].[ {aside}][ {attr1} {stood out|was the detail I noticed}.] {Nobody|No one} {rushed|hurried} anyone even though {the place|it} was {filling up|busy}. I'd go back for {obj1} alone." },
  ...
  { size: "medium", text: "{Been|Went} to {store} twice {this month|in two weeks}, which {tells you|says} {most of it|enough}. I had {obj1} both times[ and {obj2} once], and I had {no complaints|nothing to fault} either time.[ {aside}][ {attr1} {stood out|held up} {both times|each time}.] The staff {remembered us|recognised us} on the second visit, which {was a nice touch|I didn't expect}." },
  { size: "medium", text: "It's a {solid|reliable} {spot|place}. {store} {does|handles} {obj1} {well|properly}[ and {obj2} {even better|just as well}], {portions|the portions} are {generous|proper}, and the {bill|total} {never surprises you|is what you expect}.[ {aside}][ {attr1} {doesn't hurt either|helps too}.][ They ran {svc1} {smoothly|without a hitch}.] I'd recommend it." },
  { size: "medium", text: "{Booked|Went to} {store} for {a birthday|an anniversary|a family dinner} and it {went well|was the right call}. {Ordered|Shared} {obj1}[ and {obj2}] between us, {nothing|not one plate} came back {unfinished|with anything left}, and {the staff|the team} {handled|managed} {a table of six|a big table} {without missing anything|without a hitch}.[ {aside}][ {attr1} {sealed it|made the difference}.][ They {know|really know} their {range1}.]" },
  { size: "medium", text: "What I'd {mention|point to} first about {store} is {attr1}[, then {attr2}]. {We|I} {went in|came in} {on a busy night|at peak time} and {still|even then} {got looked after|never waited long}.[ {obj1} {did not disappoint either|held up too}.][ {aside}] {Prices|The prices} {are|were} {fair|sensible}, and {nobody|no one} {rushed|hurried} us out.[ For {geo1}, {this is my answer|I'd start here}.]" },
  { size: "medium", text: "Got {takeaway|delivery} from {store} {on Friday|last night|midweek} and it {travelled|held up} {fine|well}. {obj1} {travelled well|arrived in good shape}[, and {obj2} {survived the trip|came through intact}].[ {aside}][ They {handled|took care of} {svc1} {as promised|without a hitch}.] {The portions|Portions} were {generous|proper}[, and {attr1} {came through|held up} even out of the box]. {We'll|I'll} order again." },
...
const CAFE: StoryFrame[] = [
  ...
  { size: "short", text: "{obj1} at {store} {lived up to|matched} {what I'd heard|the recommendation}, and {the staff|the people behind the counter} were {lovely|genuinely friendly}.[ {aside}]" },
  ...
  { size: "short", text: "What I'd {mention|point to} first about {store} is {attr1}.[ {obj1} {held up too|did not disappoint either}.] {It's|That's} {why I keep going back|what I'd tell a friend}.[ {aside}]" },
  ...
  { size: "medium", text: "{Second|Third} time at {store} and {the standard|it} {hasn't slipped|held up}. {Had|Went for|Got} {obj1} again[, plus {obj2} this time]. {The staff|Whoever was on} {remembered|recognised} me, which {I didn't expect|was a nice touch}.[ {aside}][ {attr1} is {still|again} the part I'd {mention|point to} first.][ For {geo1}, {this is my answer|I'd start here}.]" },
  { size: "medium", text: "What I'd {mention|point to} first about {store} is {attr1}[, then {attr2}]. {I|We} {came in|turned up} {at peak time|on a busy morning} and {still|even then} {got served quickly|never waited long}.[ {obj1} {did not disappoint either|held up too}.][ {aside}] {Prices|The prices} {are|were} {fair|sensible}, and {nobody|no one} {rushed|hurried} us.[ They {know|really know} their {range1}.]" },
  { size: "medium", text: "Had {breakfast|brunch|a slow coffee} at {store} {on Sunday|on a day off|before work} and it {set the day up|was the right call}. {obj1} {came out|arrived} {quickly|fast}[, {obj2} {shortly after|right behind it}], and {nothing|none of it} {felt|tasted} {rushed|thrown together}.[ {aside}][ {attr1} {stood out|is the detail I noticed}.] {The staff|The team} were {easy|relaxed} and {quick|on it}, and {I'd|we'd} {go back|do it again} {without thinking|any weekend}." },
