...
const RESTAURANT: StoryFrame[] = [
  ...
  { size: "short", text: "{Good|Solid|Proper} {meal|dinner} at {store}. What {stood out|I remember} most is {attr1}, which {you don't get everywhere|is rarer than it should be}.[ {obj1} {held up too|did not disappoint either}.] {Would|I'd} {happily|gladly} go back." },
